...
$ns simplex-link $n8 $n9 2.4Mb 10ms CBQ/WRR
$ns simplex-link $n9 $n8 5Mb 10ms DropTail
#Receivers
...
$class2 setparams $topclass true 0.5 auto 2 1 0

$cbqlink insert $topclass
$cbqlink insert $class1
$cbqlink insert $class2

$cbqlink bind $class1 0 ; # fid 0
$cbqlink bind $class2 1 ; # fid 1
...
$exp2 set burst_time 500ms
$exp2 set idle_time_ 500ms
$exp2 set rate_ 800k

$exp3 set packetSize_ 500
$exp3 set burst_time 500ms
$exp3 set idle_time_ 500ms
$exp3 set rate_ 800k

$exp4 set packetSize_ 500
$exp4 set burst_time 500ms
$exp4 set idle_time_ 500ms
$exp4 set rate_ 800k

$exp5 set packetSize_ 500
$exp5 set burst_time 500ms
$exp5 set idle_time_ 500ms
$exp5 set rate_ 800k

$exp2 attach-agent $tcp0
$exp3 attach-agent $tcp1
$exp4 attach-agent $tcp2
$exp5 attach-agent $tcp3
...
$ns at 1.0 "$exp4 start"
$ns at 1.0 "$exp5 start"
$ns at 4.5 "$exp2 stop"
$ns at 4.5 "$exp3 stop"
$ns at 4.5 "$exp4 stop"
$ns at 4.5 "$exp5 stop"
